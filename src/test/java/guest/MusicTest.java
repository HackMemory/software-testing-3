...
public class MusicTest {
    private static final Logger logger = LoggerFactory.getLogger(MusicTest.class);
    ...
    public void musicTest() {
        drivers.forEach(driver -> {
            ...
            Utils.getElementBySelector(driver, By.cssSelector(".style-scope:nth-child(4) > #items > .style-scope:nth-child(2) > #endpoint .title")).click();

            String title = Utils.getElementBySelector(driver, By.cssSelector("#meta > #channel-name > #container #text")).getText();
            assertEquals(title, "Музыка");
